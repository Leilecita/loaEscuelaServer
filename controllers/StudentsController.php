    ...
    function getStudentsByAssistsPlanilla($localFilter,$filtersAssists,$onlyPresents, $orderby){
        ...
        if($planilla){
            ...
            if($orderby == "alf"){
                ...
                $orderby = "current_st DESC, pa_created DESC";
            }

            if($onlyPresents == 'true'){
                $filtersAssists[] = 'pp.fecha_presente = "' . $_GET['date'] . '"';
                $students = $this->model->getStudentsAssistsOnlyPresent($filtersAssists, $this->getPaginator(), $orderby);
